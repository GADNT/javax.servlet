...
/**
 *
 * <span class="changed_modified_4_0">Extends</span> the {@link
 * javax.servlet.ServletRequest} interface to provide request
...
public interface HttpServletRequest extends ServletRequest {
    ...
    /**
     * <span class="changed_added_4_0">Returns a {@link PushBuilder} for
     * issuing server push responses from the current request.  If the
     * current connection does not support server push, a valid {@code
     * PushBuilder} must still be returned, but calling any of the
     * methods on it will have no effect.</span>
     *
